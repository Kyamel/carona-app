...
import { RideSheet } from "@/components/map/ride-sheet";
...
export function MapScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      {!hasActiveRide && destination && openOffers.length > 0 && !selectedOffer ? (
        <View style={[styles.offerList, { backgroundColor: colors.background }]}>
            ...
            {openOffers.slice(0, 4).map((offer) => (
              ...
              >
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={{ color: colors.icon, fontSize: 13 }}>
                    {offer.seatsAvailable} de {offer.availableSeats} assentos livres
                  </Text>
                </View>
