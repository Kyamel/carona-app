...
import { cancelPendingJoinRequest } from "@carona/backend";

import { useSession } from "@/hooks/use-session";
import { useRideSession } from "@/providers/ride-session";
import { DriverRideView } from "@/components/ride/driver-ride-view";
import { PassengerRideView } from "@/components/ride/passenger-ride-view";
import { EmptyRide } from "@/components/ride/empty-ride";
...
export default function RideTab() {
  ...
  if (phase === "requesting" && myJoinRequest) {
    return <PendingRideRequest rideId={myJoinRequest.rideId} passengerId={user.uid} />;
  }
