...
export default function ProfileTab() {
  ...
  useEffect(() => {
    ...
    getReputation(uid).then(setReputation).catch(() => undefined);
    getCompletedRideCount(uid).then(setCompletedRides).catch(() => undefined);
  ...
  return (
    ...
    >
      ...
      {newBookmark ? (
        <Pressable
          style={[styles.saveButton, { backgroundColor: colors.tint, alignSelf: "flex-start" }]}
          onPress={addBookmark}
        >
